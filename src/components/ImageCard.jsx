  ...
  return (
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end bg-linear-to-t from-black/60 via-black/15 to-transparent opacity-100 transition duration-500">
          <div className="w-full translate-y-0 p-4 text-white transition duration-500">
